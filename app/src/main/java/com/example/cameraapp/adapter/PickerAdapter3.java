...
public class PickerAdapter3 extends RecyclerView.Adapter<PickerAdapter3.TextVH> {

    private Context context;
    public List<String> dataList2;
    private RecyclerView recyclerView;

    public PickerAdapter3(Context context, List<String> dataList, RecyclerView recyclerView) {
    ...
    public TextVH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = inflater.inflate(R.layout.picker_item_layout3, parent, false);
