...
public class Rsettings1 extends AppCompatActivity {
    ...
    TextView tvISO, tvAp, tvShutterspeed, tvSelectLight;
    String backgroundimageresponse, DSLRExposureSettingsresponse, AppContentresponse;
        ...
        try {
            ...
            if (success) {
                ...
                for (int i = 0; i < dataarray.length(); i++) {
                    JSONObject dataobj = dataarray.getJSONObject(5);
    ...
    public void onclick() {
        ...
        btnRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Rsettings1.this, MainActivity.class);
        ...
        ll_Phone.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvPhone.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.white));
                ...
                tvDSLR.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.black));
...
//                ll_DSLRdetails.setVisibility(View.GONE);
                ...
                tvPhone1.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.white));
                ...
                tvDSLR1.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.black));
                phordslr = "phone";
        ...
        ll_DSLR1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvPhone1.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.black));
                ...
                tvDSLR1.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.white));
                phordslr = "dslr";
        ...
        ll_DSLR.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                tvPhone.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.black));
                ...
                tvDSLR.setTextColor(ContextCompat.getColor(Rsettings1.this, R.color.white));
        ...
        btnGotocamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Rsettings1.this, Camerafilter.class);
...
//            @Override
//            public void run() {
//                tvAp.setText("Aperture(F-Stop): " + adapter1.dataList.indexOf(aperturedef));
//                rv_aperture.smoothScrollToPosition(adapter1.dataList.indexOf(aperturedef));
//            }
//        },1000);

        rv_shutterspeed.setOrientation(DSVOrientation.HORIZONTAL);
        adapter2 = new PickerAdapter(this, getshutterspeedData("100"), rv_shutterspeed);
        rv_shutterspeed.setAdapter(adapter2);

//        rv_shutterspeed.smoothScrollToPosition(adapter2.dataList.indexOf(shutterdef));
//        tvShutterspeed.setText("Shutter Speed: " + adapter2.dataList.indexOf(shutterdef));
       ...
       /* pickerLayoutManager.setOnScrollStopListener(new PickerLayoutManager.onScrollStopListener() {
        ...
        rv.addOnItemChangedListener(new DiscreteScrollView.OnItemChangedListener<RecyclerView.ViewHolder>() {
            ...
            public void onCurrentItemChanged(@Nullable @org.jetbrains.annotations.Nullable RecyclerView.ViewHolder viewHolder, int adapterPosition) {
                ...
                adapter1 = new PickerAdapter(Rsettings1.this, getapertureData(adapter.dataList.get(adapterPosition)), rv_aperture);
                //adapter1.notifyDataSetChanged();
                updateSutterValues(adapterPosition, adapter.dataList.get(adapterPosition));
...
//                int val = (int) view.getTag();
    ...
    private void updateSutterValues(int pos, String isoval) {
       ...
       /* "default": {
        ...
        for (int i = 0; i < Isoarry.length(); i++) {
            try {
                JSONObject dataObj = Isoarry.getJSONObject(i);
                if (dataObj.has("iso") && dataObj.getString("iso").equals(isoval)) {
                    if (dataObj.has("shutter")) {
                        JSONArray apertureArray = dataObj.getJSONArray("shutter");
                        for (int j = 0; j < apertureArray.length(); j++) {
                            list.add(apertureArray.getString(j));
                        }
                    }
                    if (dataObj.has("default")) {
                        JSONObject defaultObj = dataObj.getJSONObject("default");
                        shutterdef = defaultObj.getString("shutter");
                        aperturedef = defaultObj.getString("aperture");
...
//            public void run() {
        rv_aperture.smoothScrollToPosition(adapter1.dataList.indexOf(aperturedef));
        rv_shutterspeed.smoothScrollToPosition(list.indexOf(shutterdef));
//            }
//        }, 200);
        tvAp.setText("Aperture(F-Stop): " + adapter1.dataList.indexOf(aperturedef));
        tvShutterspeed.setText("Shutter Speed: " + adapter2.dataList.indexOf(shutterdef));
    ...
    public List<String> getData() {
        ...
        try {
            JSONObject res = new JSONObject(DSLRExposureSettingsresponse);
            String lightval = String.valueOf(totallights);
            if (totallights >= 4 && totallights <= 5) lightval = "4-5";
            if (totallights >= 6 && totallights <= 7) lightval = "6-7";
            Isoarry = res.getJSONObject("data").getJSONArray(lightval);
            for (int i = 0; i < Isoarry.length(); i++) {
                JSONObject isodata = Isoarry.getJSONObject(i);
                data.add(isodata.getString("iso"));
            }
        } catch (JSONException e) {
            e.printStackTrace();
        }
    ...
    public List<String> getapertureData(String iso) {
        List<String> data1 = new ArrayList<>();

        for (int i = 0; i < Isoarry.length(); i++) {
            try {
                JSONObject dataObj = Isoarry.getJSONObject(i);
                if (dataObj.has("iso") && dataObj.getString("iso").equals(iso)) {
                    if (dataObj.has("aperture")) {
                        JSONArray apertureArray = dataObj.getJSONArray("aperture");
                        for (int j = 0; j < apertureArray.length(); j++) {
                            data1.add(apertureArray.getString(j));
                        }
                    }
                    if (dataObj.has("default")) {
                        JSONObject defaultObj = dataObj.getJSONObject("default");
    ...
    public List<String> getshutterspeedData(String iso) {
...
//    }
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Rsettings1.this, AdditionalLight.class);
        intent.putExtra("lightnumber", Lightnumber);
        intent.putExtra("light", light);
        intent.putExtra("phordslr", phordslr);
        startActivity(intent);
